...
// 1. Extract the form into its own component
function LoginContent() {
  const [isSignUp, setIsSignUp] = useState(false);
  
  // This hook is what was causing Vercel to panic during the build
...
export default function Login() {
  return (
    <div className="min-h-screen bg-stone-50 flex flex-col justify-center items-center p-4">
      <Suspense fallback={<div className="text-slate-500 animate-pulse font-medium">Loading secure login...</div>}>
        <LoginContent />
      </Suspense>
    </div>
  );
